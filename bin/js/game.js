window.addEventListener('DOMContentLoaded', function () {
    ...
    var update = function () {
        ...
        if (cameraZ > meshesLoadedToZ) {
            for (var _i = 0, grounds_1 = grounds; _i < grounds_1.length; _i++) {
                var ground = grounds_1[_i];
                ground.position.z += loadOffsetZ;
            }
            meshesLoadedToZ += loadOffsetZ;
        }
        for (var _a = 0, playerTankMeshes_1 = playerTankMeshes; _a < playerTankMeshes_1.length; _a++) {
            var mesh = playerTankMeshes_1[_a];
